...
class Alumnos
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Empresa", inversedBy="nAlumnos")
     * @ORM\JoinColumn(name="nEmpresa", referencedColumnName="id")
     */
    private $nEmpresa;
     ...
     * Set nEmpresa
     *
     * @param \GfctBundle\Entity\Empresa $nEmpresa
     *
     * @return Alumnos
     */
    public function setNEmpresa(\GfctBundle\Entity\Empresa $nEmpresa = null)
    {
