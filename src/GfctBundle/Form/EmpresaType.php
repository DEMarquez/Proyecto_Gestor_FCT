    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('cp',IntegerType::class,array('label'=>'Codigo Postal',
                                                 'label_attr'=>array('class' => 'etiqueta'),
                                                 'attr' => array('class' => 'etiqueta_elemento')))
            ->add('telefono1',IntegerType::class,array('label'=>'Telefono 1',
                                                 'label_attr'=>array('class' => 'etiqueta'),
                                                 'attr' => array('class' => 'etiqueta_elemento')))
            ->add('telefono2',IntegerType::class,array('label'=>'Telefono 2',
                                                 'label_attr'=>array('class' => 'etiqueta'),
                                                 'attr' => array('class' => 'etiqueta_elemento')))
            ->add('fechaCreacion',DateType::class,array('label'=>'Fecha creacion',
                                                 'label_attr'=>array('class' => 'etiqueta'),
                                                 'attr' => array('class' => 'etiqueta_elemento')))
